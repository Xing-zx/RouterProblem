global Sxy
[Sxy,AM]=NetCreate(10,30,10,100,1,0);
 hold off
S=1;
E=[25,27,29];
...
%     decomposeTree(route,E);
    figure(1)
    hold off
    Net_plot(10,30,Sxy,1,1,route);
    pause(0.5);
    figure(2)
    hold off
    Net_plot(10,30,Sxy,1,1,OptRoute);
    pause(0.5);  
    figure(3)
    hold off
    Net_plot(10,30,Sxy,1,1,newTree);
    pause(0.5);
    route=newTree;
 end 
% for i=1:20
...
%     Net_plot(BorderLength,NodeAmount,Sxy,PlotIf,1,tree);
%     hold off
%     pause(0.5);
% end
% tree=InitializeTree(S,E,AM);
